...
{
    private ScssRenderer _instance = null!;
    ...
    public void SetUp()
    {
        ...
        this._instance = new ScssRenderer(this._fileSystemService);
    }
    ...
    public async Task GetImports_WithMultipleInline_Return()
    {
        ...
        importResults.Should().Contain("foundation/code.scss");
        importResults.Should().Contain("foundation/_code.scss");
        importResults.Should().Contain("foundation/lists/");
        importResults.Should().Contain("foundation/lists.scss");
        importResults.Should().Contain("foundation/_lists.scss");
    }
