...
public class HtmlRendererTests
{
    ...
    public async Task RenderHtmlAsync_WithMarkdownFileTag_Return()
    {
        ...
        var expectedHtml = new StringBuilder()
            ...
            .AppendLine("<h1>Hello World!</h1>")
            .AppendLine("<section>")
            .AppendLine("<h1 id=\"title\">Title</h1>")
            .AppendLine("<h2 id=\"subtitle\">Subtitle</h2>")
    ...
    [TestMethod]
    public async Task RenderHtmlAsync_WithMarkdownWithTagsInContent_Return()
    {
        string sourceFullFilePath = "/project/src/index.html";
        string sourceDirectory = "/project/src";
        string outputDirectory = "/project/dist";
        ...
        var expectedHtml = new StringBuilder()
            ...
            .AppendLine("")
            .AppendLine("")
            .AppendLine("<p>@PageTitle")
            .AppendLine("@BuildDate")
            .AppendLine("@StylePath</p>")
            .AppendLine("")
            .AppendLine("</body>")
            .AppendLine("</html>")
            .ToString().Trim();
